      ...
      <StyledCard sx={{ m: { xs: 1, sm: 2 } }}>
        ...
        <CardContent>
          ...
          <Box sx={{ display: "flex", alignItems: "center", mt: 1 }}>
            ...
            ></i>(<i className="fas fa-user"></i> {parlor.countPeople} Ratings)
          </Box>
          <Typography
            variant="body2"
            sx={{
      ...
      >
        ...
        >
          ...
          <form onSubmit={handleLogin}>
            ...
            <Typography
              textAlign="center"
              sx={{ fontSize: { xs: "12px", sm: "14px" }, mt: 2 , color: "#000"}}
            >
...
const useGoogleMapsAutocomplete = (inputRef, setLocationInput, setUserLocation) => {
...
const Product = () => {
  ...
  useGoogleMapsAutocomplete(autocompleteInputRef, setLocationInput, setUserLocation);
