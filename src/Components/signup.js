...
export default function SignupForm() {
  ...
  const inputSx = {
    ...
    '& .MuiInputBase-input': {
      color: 'black', // Ensure entered text is white
    },
    '& .MuiInputBase-input.Mui-disabled': {
      color: 'black', // Ensure disabled input text (e.g., Location) is white
      WebkitTextFillColor: 'black', // Fix for Safari/Chrome autofill or disabled text
        ...
        >
                ...
                <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
                  <Button
                    ...
                    sx={{
                      ...
                      color: '#000',
                      '&:hover': {
                        backgroundImage: 'linear-gradient(135deg,rgb(160, 231, 216) 0%, #d9f5ef 100%)',
                        color: '#000',
                      },
                    }}
                  >
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center' }}>
            <MuiLink
              ...
              to="/login"
              underline="hover"
              sx={{ fontSize: { xs: 12, sm: 14 }, color: '#000', '&:hover': { color: '#17a388' } }}
            >
