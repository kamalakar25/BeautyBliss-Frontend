      ...
      >
        <Button
          ...
          sx={{
            ...
            letterSpacing: "0.5px",
            boxShadow: "0 4px 12px rgba(26, 188, 156, 0.4)", // Subtle shadow effect
            ...
            "&:hover": {
              ...
              boxShadow: "0 6px 16px rgba(26, 188, 156, 0.6)", // Enhanced shadow on hover
            },
            "&:before": {
              content: '""',
              position: "absolute",
                ...
                {validContent.map((_, index) => (
                  <Box
                    ...
                    sx={{
                      ...
                      height: 10,
                      borderRadius: "50%",
                      bgcolor: activeIndex === index ? "#17a388" : "grey.500",
                      cursor: "pointer",
                      transition: "background-color 0.3s",
                      "&:hover": {
                        bgcolor: activeIndex === index ? "#17a388" : "grey.400",
                      },
                    }}
                  />
                ))}
            ...
            >
              ...
              >
                <Button
                  ...
                  sx={{
                    backgroundImage: "linear-gradient(45deg, #1abc9c, #16a085)", // Elegant gradient background
                    ...
                    "&:hover": {
                      backgroundImage:
                        "linear-gradient(45deg,rgb(147, 172, 197), #34495e)", // Hover gradient effect
                      transform: "scale(1.1)", // Slightly zoom in effect
